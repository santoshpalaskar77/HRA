...
parser.add_argument("--test_len",        default=4, type=int, help="test length")
...
parser.add_argument("--batch_size",        default=16, type=int, help="output chunk length")
...
rng = pd.date_range(start, periods=36, freq='Q')
index = pd.Index(rng)
df1 = df
...
day_series = datetime_attribute_timeseries(
    series_en_transformed, attribute="quarter", one_hot=True
)
scaler_day = Scaler()
